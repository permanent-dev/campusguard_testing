...
import { Camera, Shield, User, AlertCircle, CheckCircle, Clock, Search, Plus, LogOut, Menu, X, Eye, EyeOff, UserCog, UserCog2Icon } from 'lucide-react';
...
const CampusGuardApp = () => {
  ...
  // Landing Page
  const LandingPage = () => (
    <div className="min-h-screen rounded-md bg-gradient-to-b from-blue-400 via-blue-700 to-purple-800">
      <div className="mx-auto px-4 py-8">
        <div className="text-center text-white mb-52">
        ...
        <div className="grid md:grid-cols-3 gap-6 mx-auto">
          <div className="bg-gray-200 rounded-2xl p-8 shadow-2xl transform hover:scale-105 transition cursor-pointer"
          ...
          <div className="bg-gray-200 rounded-2xl p-8 shadow-2xl transform hover:scale-105 transition cursor-pointer"
            ...
            <UserCog2Icon className="w-12 h-12 text-purple-600 mb-4 mx-auto" />
  ...
  const StudentRegister = () => (
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="container mx-auto px-4 py-8 w-screen items-center">
        {!emailSent ? (
          <div className="bg-white/60 backdrop-blur-md glass rounded-xl shadow-lg p-8">
          ...
          <div className="bg-white rounded-xl shadow-lg p-8">
            ...
            <button
              ...
              className=" bg-gray-600 text-white py-3 px-2 rounded-lg font-semibold hover:bg-gray-700 transition"
            >
  ...
  // Login Page
  const LoginPage = () => (
    <div className="min-h-screen bg-gradient-to-b from-blue-200 via-blue-500 to-purple-600 w-screen flex items-center justify-center">
      <div className="bg-white/20 backdrop-blur-sm glass rounded-2xl shadow-2xl p-8 mx-4">
        ...
        <div className="space-y-4">
          ...
          <button
            ...
            className=" text-gray-300 hover:text-gray-800 text-sm"
          >
            Back to Home
          </button>
        </div>
    ...
    <div className="min-h-screen bg-gray-50">
      <nav className="bg-white shadow-sm border-b">
        <div className="container mx-auto px-4">
          <div className="flex justify-between items-center py-4">
            <div className="flex items-center">
              <Shield className="w-10 h-8 text-blue-600 mr-2" />
              <h1 className="text-3xl font-bold text-gray-800">CampusGuard {userRole === 'admin' ? 'Admin' : 'Security'}</h1>
            </div>
            <div className="flex items-center space-x-4">
              <button onClick={() => setMobileMenuOpen(!mobileMenuOpen)} className="lg:hidden">
                {mobileMenuOpen ? <Menu className="w-8 h-8" /> : <X className="w-8 h-8" />}
              </button>
              <button onClick={() => setCurrentView('landing')} className="bg-gradient-to-r from-blue-300 to-indigo-700 flex items-center text-gray-200 hover:text-gray-800">
                <LogOut className="w-5 h-5 mr-1" />
                <span className="hidden sm:inline">Logout</span>
              </button>
            </div>
                  ...
                  <tbody className="divide-y">
                    {mockOffences.map(offense => (
                      <tr key={offense.id} className="hover:bg-gray-50">
                        ...
                        <td className="px-6 py-4">
                          <span className={`px-3 py-1 rounded-full text-xs font-medium ${offense.severity === 'HIGH' || 'CRITICAL' ? 'bg-red-100 text-red-700' :
                            offense.severity === 'MEDIUM' ? 'bg-orange-100 text-orange-700' :
                              'bg-yellow-100 text-yellow-700'
                            }`}>
                            {offense.severity}
            ...
            <div>
              ...
              <div className="grid grid-cols-4 gap-2">
                {severityLevels.map(level => (
                  <button
                    key={level}
                    className={`px-2 py-2 rounded-lg font-medium ${level === 'CRITICAL' ? 'bg-red-100 text-red-700 hover:bg-red-200' :
      ...
      <nav className="bg-white shadow-sm border-b">
        <div className="px-4 py-4">
          <div className="flex items-center justify-between">
            <div className="flex items-center">
              <Shield className="w-8 h-8 text-blue-600 mr-2" />
              <h1 className="text-lg font-bold text-gray-800">Face Recognition</h1>
            </div>
            <button onClick={() => setCurrentView('admin-dashboard')} className="text-gray-300 bg-gradient-to-b from-blue-600 to-indigo-400 flex justify-between items-center" >
              <LogOut className='w-5 h-7 mr-1' />
